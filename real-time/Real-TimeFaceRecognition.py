...
#"http://192.168.1.5:9999/stream.mjpeg"
# Load a sample picture of yourself and learn how to recognize it.
mavin_image = face_recognition.load_image_file("images/mavin.png")
mavin_face_encoding = face_recognition.face_encodings(mavin_image)[0]
...
#kishore_image = face_recognition.load_image_file("kishore.jpg")
